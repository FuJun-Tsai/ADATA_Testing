...
<li>Qualified participants who do not win in the lucky draw will be included in the next eligible draw. If organizers find multiple accounts registered with the same address and/or telephone number, they will be treated as the same applicant. In disputes concerning qualified entries, ADATA retains the right to make the final decision.
</li>
<li>Prizes are subject to availability. Prizes are non-transferable and non-exchangeable for cash, unless otherwise specified. In the event ADATA is unable to provide the stated prize, ADATA reserves the right to award a different prize at its discretion.
</li>
<li>ADATA shall not be responsible for any inaccuracy in any information, and/or personal or contact particulars provided by participants, and shall not be liable for any such errors or any loss suffered by participants as a result.
</li>
<li>These Terms and Conditions are to be construed, governed and interpreted in accordance with the laws of Taiwan and all parties agree to submit to the exclusive jurisdiction of Taiwan's courts.
</li>
...
<li>ADATA will notify winners on <span>November 10, 2016.</span> If winners does not reply to their winning status notification within a specified time, they forfeit their winning status. In such an event, ADATA reserves the right to redraw a new winner for the prize in any manner it deems fit, at its sole discretion.
</li>
<li>Prizes will be shipped to addresses provided by winners in the period of <span>December 1 to 16, 2016.</span>
</li>
...
<li>ADATA reserves the right to amend, revise, delete, edit, add to, and/or withdraw these terms and conditions and the prizes at any time without notice, in which event, ADATA shall have no liability whatsoever to any person and/or entity as a result thereof.
</li>
";
